...
const filterByPrice = (min, max) => {
	fetch(`/filter-products?minPrice=${min}&maxPrice=${max}`)
		.then(res => res.text())
		.then(data => { 
...
const filterByPrice_debounced = debounce(filterByPrice, 420);
	...
	var siteSliderRange = function () {
		$("#slider-range").slider({
			...
			slide: function (event, ui) {
				...
				filterByPrice_debounced(ui.values[0], ui.values[1]);
			}
		});
